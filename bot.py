...
async def main() -> None:
    ...
    scheduler.add_job(remind1, "date", run_date=datetime(2023, 12, 20, 12, 0))
    scheduler.add_job(remind2, "date", run_date=datetime(2023, 12, 21, 12, 0))
    scheduler.add_job(remind3, "date", run_date=datetime(2023, 12, 22, 12, 0))
    scheduler.add_job(remind4, "date", run_date=datetime(2023, 12, 23, 12, 0))
    scheduler.add_job(send_pre_message, "date", run_date=datetime(2023, 12, 24, 12, 0))
    scheduler.add_job(remind5, "date", run_date=datetime(2023, 12, 27, 12, 0))
    scheduler.add_job(remind6, "date", run_date=datetime(2023, 12, 28, 12, 0))
    scheduler.add_job(remind7, "date", run_date=datetime(2023, 12, 29, 12, 0))
    scheduler.add_job(remind8, "date", run_date=datetime(2023, 12, 30, 12, 0))
    scheduler.add_job(send_message, "date", run_date=datetime(2024, 1, 1, 0, 10))
    scheduler.start()
